...
int main()
{
    ...
    while (!window->IsShouldClose())
    {
        ...
        shaderProgram->Uniform("light.ambient", vec3(0.2f, 0.2f, 0.2f));
        shaderProgram->Uniform("light.diffuse", vec3(0.5f, 0.5f, 0.5f));
        ...
        shaderProgram->Uniform("material.ambient", vec3(1.0f, 0.5f, 0.31f));
        shaderProgram->Uniform("material.diffuse", vec3(1.0f, 0.5f, 0.31f));
        shaderProgram->Uniform("material.specular", vec3(0.5f, 0.5f, 0.5f));
        shaderProgram->Uniform("material.shininess", 32.0f);
